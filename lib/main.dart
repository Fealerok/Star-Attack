...
Future<void> main() async {
  ...
  runApp(
    MultiProvider(
      providers: [
        ChangeNotifierProvider(create: (context) => NasaDataProvider()),
...
class NasaDataProvider extends ChangeNotifier {
  String imageUrl = '';
  String explanation = '';
  ...
  Future<void> fetchNasaApod() async {
    final apiKey = '8qmxWtibvejdwAGhwH3bdT50Z5okbkEgphKnFN0f';
    ...
    if (response.statusCode == 200) {
      ...
      notifyListeners(); // Уведомление всех слушателей об обновлении состояния
    } else {
